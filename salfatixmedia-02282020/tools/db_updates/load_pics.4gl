FUNCTION load_pics()
  CALL load_a_picture(1, "../../res/imgs/avatar.png")
  CALL load_a_picture(2, "../../res/imgs/movie.png")
  CALL load_a_picture(50, "../../res/imgs/add_photo.png")
  CALL load_a_picture(51, "../../res/imgs/add_campaign_banner.png")
