...
gbcTemplates["LogPlayerWidget"] = "<div>\n" +
   ...
   "    <span>Log file</span>\n" +
   "    <input type=\"file\" class=\"logplayer-fileinput mt-field\">\n" +
   "    <span class=\"logplayer-domCount\"></span>\n" +
   "    <span>Delay between orders (ms)</span>\n" +
   ...
   "    <button class=\"logplayer-play mt-button\" title=\"Play\"><i class=\"zmdi zmdi-play\"></i></button>\n" +
...
gbcTemplates["HBoxSplitViewWidget"] = "<div class=\"containerElement\"></div>";

gbcTemplates["HBoxWidget"] = "<div class=\"containerElement\" role=\"group\"></div>";
...
gbcTemplates["VBoxWidget"] = "<div class=\"containerElement\" role=\"group\"></div>";
...
gbcTemplates["TimeEditMobileWidget"] = "<div class=\"mt-field  gbc_MobileWidget\">\n" +
   ...
   "  </div>\n" +
   "  <label class=\"gbc_TimeEditWidget_arrows\">\n" +
   "    <div class=\"up\"><span>▲</span></div>\n" +
   "    <div class=\"down\"><span>▼</span></div>\n" +
   "  </label>\n" +
   "</div>";
...
gbcTemplates["ProgressBarWidget"] = "<div tabindex=\"0\" class=\"mt-progress gbc_dataContentPlaceholder\" role=\"progressbar\">\n" +
   ...
   "  </div>\n" +
   "  <div class=\"mt-progress-bar-percentage\">..</div>\n" +
   "\n" +
   "</div>";
