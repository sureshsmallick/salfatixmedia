    ...
    context.MouseService = context.oo.StaticClass( /** @lends gbc.MouseService */ {
      ...
      _onClick: function(event) {
        ...
        if (widget) {
          ...
          context.LogService.mouse.log("onClick processed event : ", event);
        }
      },
      ...
      _onRightClick: function(event) {
        ...
        if (widget) {
          ...
          context.LogService.mouse.log("onRightClick processed event : ", event);
        }
      },
      ...
      _onDblClick: function(event) {
        ...
        if (widget) {
          ...
          context.LogService.mouse.log("onDblClick processed event : ", event);
        }
      }
