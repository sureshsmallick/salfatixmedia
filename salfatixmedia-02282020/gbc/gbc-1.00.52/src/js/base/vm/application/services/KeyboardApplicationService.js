      ...
      return /** @lends classes.KeyboardApplicationService.prototype */ {
          ...
          if (!processed) {
            ...
            if (actionNode) {
              ...
              if (cls.ActionApplicationService.getLocalActionNames().contains(actionName)) {
                ...
                processed = this._processLocalAction(actionName, actionNode.attribute('acceleratorName'), actionNode);
              } else {
          ...
          if (!vmEvent && !processed) {
            ...
            if (actionNode) {
              ...
              if (cls.ActionApplicationService.browserNativeActions.contains(actionName)) {
                ...
                processed = this._processLocalAction(actionName, actionNode.attribute('acceleratorName'));
              } else {
        ...
        _processLocalAction: function(actionName, actionAccelerator, actionNode) {
          ...
          if (focusedNodeController) {
            if (focusedNodeController.sendCursors) {
              focusedNodeController.sendCursors();
            }
            if (focusedNodeController.sendWidgetValue) {
