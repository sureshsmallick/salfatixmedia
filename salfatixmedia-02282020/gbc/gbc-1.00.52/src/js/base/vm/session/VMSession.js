    ...
    cls.VMSession = context.oo.Class(cls.EventListener, function($super) {
      return /** @lends classes.VMSession.prototype */ {
        ...
        constructor: function(identifier) {
          ...
          this._restartHandler = this._widget.getEndWidget().when(context.constants.widgetEvents.restart, this._onRestart.bind(this));
              ...
              switch (this._applicationEnding.flag) {
                ...
                case "notok":
                  this.getWidget().getEndWidget().setMessage(
                    "<p data-details='notok'>" + i18next.t("gwc.app.error.message") + ".</p><p>" + this._applicationEnding.message +
                    "</p>");
                  break;
                case "forbidden":
                  this.getWidget().getEndWidget().setMessage(
                ...
                case "uaProxy":
                  this.getWidget().getEndWidget().setMessage(
                    "<p data-details='uaProxy'>" + i18next.t("gwc.app.uaProxy.message") + ".</p><p>" + this._applicationEnding.message +
                    "</p>");
                  break;
              }
            }
              ...
              info.tabbedContainerWidget.when(context.constants.widgetEvents.change, function(event, src, page) {
                ...
                if (page && page._tabbedAppWidget) {
                  ...
                  var displayedWindow = page._tabbedApp.getVMWindow(),
                    displayedWindowWidget = displayedWindow && displayedWindow.getController() && displayedWindow.getController()
                    .getWidget();
        ...
        addApplicationWidget: function(app, appWidget) {
          if (this._tabbedContainerInfo.windowNode) {
            ...
            appWidget.when(context.constants.widgetEvents.destroyed, function() {
              ...
              this._registerAnimationFrame(function() {
                if (this._tabbedContainerInfo.tabbedContainerWidget && this._tabbedContainerInfo.tabbedContainerWidget.updateScrollersVisibility) {
