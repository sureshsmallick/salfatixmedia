    ...
    cls.SettingsWidget = context.oo.Class(cls.WidgetGroupBase, function($super) {
      return /** @lends classes.SettingsWidget.prototype */ {
        ...
        _initElement: function() {
          ...
          //Language widget
          this._lngDefaultWidget = cls.WidgetFactory.createWidget("CheckBox", this.getBuildParameters());
          ...
          this._lngWidget = cls.WidgetFactory.createWidget("ComboBox", this.getBuildParameters());
          ...
          this._lngWidget.when(context.constants.widgetEvents.click, function(event, data) {
            this._lngWidget._dropDown.toggle();
          }.bind(this));
          ...
          this._themeWidget = cls.WidgetFactory.createWidget("ComboBox", this.getBuildParameters());
          ...
          this._enableWidget = cls.WidgetFactory.createWidget("CheckBox", this.getBuildParameters());
          ...
          this._resetWidget = cls.WidgetFactory.createWidget("Button", this.getBuildParameters());
          ...
          if (context.DebugService.isActive()) {
            this._typeaheadWidget = cls.WidgetFactory.createWidget("Edit", this.getBuildParameters());
