...
modulum('FlowDecoratorWidget', ['WidgetGroupBase', 'WidgetFactory'],
  function(context, cls) {
    /**
     * Widget to handle overflowing items in a dropdown
     * @memberOf classes
     * @extends classes.FlowDecoratorWidget
     * @publicdoc Widgets
     */
    cls.FlowDecoratorWidget = context.oo.Class(cls.WidgetBase, function($super) {
      return /** @lends classes.FlowDecorator.prototype */ {
        ...
        _initElement: function() {
          ...
          // Default is not flowing: don't show the 3 dots
          this.setHidden(true);
        },
