  ...
  function(context, cls) {
    ...
    cls.WindowWidget = context.oo.Class(cls.WidgetGroupBase, function($super) {
      return /** @lends classes.WindowWidget.prototype */ {
        ...
        setPosition: function(pos) {
          ...
          if (isPosField && this._modalWidget) {
            var rect = pos.getElement().getBoundingClientRect(),
              ...
              chromeBarRect = chromeBar && chromeBar.getElement().getBoundingClientRect(); // Taking care of chromebar height in placement if any
         ...
         *
         * @private
         * @param hasWebComponent
         */
        setHasWebComponent: function(hasWebComponent) {
          this._hasWebcomp = hasWebComponent;
        },

        /**
         * returns true if this window contains at least one web component
         * @publicdoc
         * @return {boolean} true if this window contains at least one web component
         */
