    ...
    cls.ButtonWidget = context.oo.Class(cls.TextWidgetBase, function($super) {
      return /** @lends classes.ButtonWidget.prototype */ {
        ...
        manageMouseClick: function(domEvent) {
          ...
          if (this._buttonType === 'link' && (domEvent.target.tagName.toLowerCase() !== 'span' && domEvent.target.tagName.toLowerCase() !==
              'img')) {
            return true;
          }
        ...
        setImage: function(image) {
          ...
          if (image.length !== 0) {
            if (!this._image) {
              ...
              this._image = cls.WidgetFactory.createWidget('Image', opts);
