      ...
      return /** @lends classes.ChromeBarWidget.prototype */ {
        ...
        addToolBar: function(toolbarWidget, order) {
          ...
          children.forEach(function(child) {
            ...
            if (child.__name !== "ToolBarSeparatorWidget") { // Skip toolbar separators in chromebar
        ...
        _refresh: function(force) {
          if (force || this.needRefresh()) { // Check if a refresh is really needed
            ...
            // Put everything in the topbardom for measurement
            sortedItemList = sortedItemList.concat(sortedGbcItemList);
            ...
            if (children) {
              ...
              var availableSpace = this.getLayoutInformation().getRawMeasure().getWidth() - this.getLayoutInformation().getDecorating()
                .getWidth();
        ...
        needRefresh: function() {
          ...
          if (children) {
            ...
            for (var i = 0; i < children.length; i++) {
              if (children[i].getLayoutInformation().getRawMeasure().getWidth()) {
                currentUsedWidth = currentUsedWidth + children[i].getLayoutInformation().getRawMeasure().getWidth(); // get item layout engine
              }
            }
          ...
          return childrenOverflow || changedUsedWidth || this._refreshConditions.screenOrientation !== window.orientation ||
        ...
        /**
         * Add an item as a child or as a right sidebar child
