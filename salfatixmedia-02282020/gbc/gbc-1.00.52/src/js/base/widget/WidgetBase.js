      ...
      return /** @lends classes.WidgetBase.prototype */ {
        ...
        _destroyStyle: function() {
          if (this._stylingContext === "widget") {
            styler.removeStyleSheet(this.getUniqueIdentifier());
          } else if (this._stylingContext === "window") {
            var win = this.getWindowWidget();
            var sheetId = win && win.getUniqueIdentifier() || this._appHash || "_";
            styler.appendStyleSheet({}, this.getRootClassName(), true, sheetId);
          } else {
            styler.appendStyleSheet({}, this.getRootClassName(), true, this._appHash || "_");
          }
        },
        ...
        setStyle: function(selector, style) {
          ...
          styler.appendStyleSheet(this._stylesheet,
        ...
        setFocus: function(fromMouse) {
          ...
          if (userInterfaceWidget) {
            ...
            userInterfaceWidget.emit(context.constants.widgetEvents.splitViewChanged);
        ...
        /**
         * Get the list of classes of the widget
        ...
        setAuiName: function(name) {
          if (!!this._element && (name !== this._auiName)) {
            ...
            if (typeof(name) === "undefined" || name === "") {
              this._element.removeAttribute("data-aui-name");
            } else {
              this._element.setAttribute("data-aui-name", name);
            }
          }
        },
         ...
         */
        isElementInDOMBody: function() {
          return !!this._element && this._element.isInDOMBody();
        },
        ...
        setInterruptableActive: function(isActive) {
          if (this._element) {
            if (isActive) {
              this._element.setAttribute("interruptable-active", "interruptable-active");
            } else {
              this._element.removeAttribute("interruptable-active");
            }
          }
        },
        ...
        manageMouseRightClick: function(domEvent) {
          ...
          if (this.shouldShowApplicationContextMenu()) {
            ...
            if (appWidget && context.ThemeService.getValue("theme-disable-context-menu") === false) {
              appWidget.showContextMenu(domEvent.data ? domEvent.data[0] : domEvent, /*this.isInTable() ? this.getTableWidgetBase() :*/
                this);
        ...
        setAriaRole: function(roleName) {
          if (roleName && this.getElement()) {
            this.getElement().setAttribute("role", roleName);
          }
        },
        ...
        setAriaAttribute: function(attrName, attrVal) {
          if (this.getElement()) {
            if (attrName && attrVal) {
              this.getElement().setAttribute("aria-" + attrName, attrVal.toString());
            }
            if (attrName && attrVal === null) {
              this.getElement().removeAttribute("aria-" + attrName);
            }
          }
        },
        ...
        getAriaAttribute: function(attrName) {
          if (this.getElement() && attrName) {
            return this.getElement().getAttribute("aria-" + attrName);
          }
        },
