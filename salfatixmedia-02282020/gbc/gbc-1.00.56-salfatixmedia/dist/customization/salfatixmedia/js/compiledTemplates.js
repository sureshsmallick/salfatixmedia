...
gbcTemplates["StretchableScrollGridLineWidget"] = "<div class=\"nohighlight\" style=\"width: 256px;\n" +
   "height: 188px;\n" +
   "border-radius: 8px;\n" +
   "margin-right: 20px;\n" +
   "padding-left: 0px;\n" +
   "box-shadow: 0 2px 5px 0 rgba(83, 97, 255, 0.05);\n" +
   "background-image: linear-gradient(125deg, #44dec5 9%, #4ebcfa 100%);\" >\n" +
   "<div class=\"containerElement\"></div>\n" +
   "</div>";
...
gbcTemplates["TraditionalScreenWidget"] = "<div class=\"containerElement\">Yugandhar</div>";
...
gbcTemplates["WindowWidget"] = "<form>\n" +
   ...
   "                <img id =\"imag\" class=\"imag\" src=\"https://arh-staging-angular.armentum.co/assets/img/login-image.png\">\n" +
   "\n" +
   "                <div class=\"containerElement\"></div>\n" +
   "            </div>\n" +
   "            \n" +
...
gbcTemplates["TextEditWidget"] = "<div class=\"gbc_dataContentPlaceholder\">\n" +
   "  <textarea></textarea>\n" +
   "</div>";
...
gbcTemplates["Myloginpage"] = "<!DOCTYPE html>\n" +
   "<html>\n" +
   "<head>\n" +
   ...
   "  <div id =\"salfatixlogo\" class=\"container\">\n" +
   "    <h1>Register</h1>\n" +
