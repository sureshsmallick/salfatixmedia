...
module.exports = grunt => {
  ...
  config.customizationSuffix = grunt.option("customizationSuffix") || confFile.customizationSuffix;
  if (config.customizationSuffix && !/^([\w. ,()[{}\]~…-]|[^\u0000-\u007F])+$/u.test(config.customizationSuffix)) {
    throw new Error(`Given customizationSuffix ('${config.customizationSuffix}') contains invalid characters`)
  }
