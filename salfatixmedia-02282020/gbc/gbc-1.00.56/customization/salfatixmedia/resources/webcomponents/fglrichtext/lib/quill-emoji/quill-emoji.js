...
!function(e) {
  function o(r) {
    ...
    ;
    return e[r].call(c.exports, c, c.exports, o),
        c.l=!0,
        c.exports
  }
  var a= {}
...
([function(e, o, a) {
  ...
  , function(e, o, a) {
    !function(o) {
      ...
      function r(e, o) {
        var a;
        this.list=e, this.options=o=o|| {}
        ;
        for(a in i)i.hasOwnProperty(a)&&("boolean"==typeof i[a]?this.options[a]=a in o?o[a]: i[a]: this.options[a]=o[a]||i[a])
      }
      function c(e, o, a) {
        var r, d, i, m, t, _;
        if(o) {
          if(i=o.indexOf("."), -1!==i?(r=o.slice(0, i), d=o.slice(i+1)): r=o, null!==(m=e[r])&&void 0!==m)if(d||"string"!=typeof m&&"number"!=typeof m)if(n(m))for(t=0, _=m.length;
                                                                                                                                                                   t<_;
                                                                                                                                                                   t++)c(m[t], d, a);
          else d&&c(m, d, a);
          else a.push(m)
      ...
      function d(e, o) {
        o=o|| {}
            , this.options=o, this.options.location=o.location||d.defaultOptions.location, this.options.distance="distance"in o?o.distance: d.defaultOptions.distance, this.options.threshold="threshold"in o?o.threshold: d.defaultOptions.threshold, this.options.maxPatternLength=o.maxPatternLength||d.defaultOptions.maxPatternLength, this.pattern=o.caseSensitive?e: e.toLowerCase(), this.patternLen=e.length, this.patternLen<=this.options.maxPatternLength&&(this.matchmask=1<<this.patternLen-1, this.patternAlphabet=this._calculatePatternAlphabet())
      }
      var i= {
            id:null, caseSensitive:!1, include:[], shouldSort:!0, searchFn:d, sortFn:function(e, o) {
              return e.score-o.score
            }
            , getFn:c, keys:[], verbose:!1, tokenize:!1, matchAllTokens:!1, tokenSeparator:/ +/g, minMatchCharLength:1, findAllMatches:!1
          }
      ;
      r.VERSION="2.7.3", r.prototype.set=function(e) {
        return this.list=e, e
      }
          , r.prototype.search=function(e) {
        return this.options.verbose&&a("\nSearch term:", e, "\n"), this.pattern=e, this.results=[], this.resultMap= {}
            , this._keyMap=null, this._prepareSearchers(), this._startSearch(), this._computeScore(), this._sort(), this._format()
      }
          , r.prototype._prepareSearchers=function() {
        var e=this.options, o=this.pattern, a=e.searchFn, r=o.split(e.tokenSeparator), c=0, n=r.length;
        if(this.options.tokenize)for(this.tokenSearchers=[];
                                     c<n;
                                     c++)this.tokenSearchers.push(new a(r[c], e));
        this.fullSeacher=new a(o, e)
      }
          , r.prototype._startSearch=function() {
        var e, o, a, r, c=this.options, n=c.getFn, d=this.list, i=d.length, m=this.options.keys, t=m.length, _=null;
        if("string"==typeof d[0])for(a=0;
                                     a<i;
                                     a++)this._analyze("", d[a], a, a);
        else for(this._keyMap= {}
                     , a=0;
                 a<i;
                 a++)for(_=d[a], r=0;
                         r<t;
                         r++) {
            if("string"!=typeof(e=m[r])) {
              if(o=1-e.weight||1, this._keyMap[e.name]= {
                    weight: o
                  }
            ...
            ;
            this._analyze(e, n(_, e, []), _, a)
          }
      }
          , r.prototype._analyze=function(e, o, r, c) {
        var d, i, m, t, _, s, l, f, g, h, u, y, j, p, b, k=this.options, w=!1;
        if(void 0!==o&&null!==o) {
          i=[];
          var v=0;
          if("string"==typeof o) {
            if(d=o.split(k.tokenSeparator), k.verbose&&a("---------\nKey:", e), this.options.tokenize) {
              for(p=0;
                  p<this.tokenSearchers.length;
                  p++) {
                for(f=this.tokenSearchers[p], k.verbose&&a("Pattern:", f.pattern), g=[], y=!1, b=0;
                    b<d.length;
                    b++) {
                  h=d[b], u=f.search(h);
                  var x= {}
                  ;
                  u.isMatch?(x[h]=u.score, w=!0, y=!0, i.push(u.score)): (x[h]=1, this.options.matchAllTokens||i.push(1)), g.push(x)
                }
                y&&v++, k.verbose&&a("Token scores:", g)
              }
              for(t=i[0], s=i.length, p=1;
                  p<s;
                  p++)t+=i[p];
              t/=s, k.verbose&&a("Token score average:", t)
            }
            l=this.fullSeacher.search(o), k.verbose&&a("Full text score:", l.score), _=l.score, void 0!==t&&(_=(_+t)/2), k.verbose&&a("Score average:", _), j=!this.options.tokenize||!this.options.matchAllTokens||v>=this.tokenSearchers.length, k.verbose&&a("Check Matches", j), (w||l.isMatch)&&j&&(m=this.resultMap[c], m?m.output.push( {
                  key: e, score: _, matchedIndices: l.matchedIndices
                }
            ):(this.resultMap[c]= {
              item:r, output:[ {
                key: e, score: _, matchedIndices: l.matchedIndices
                ...
                , this.results.push(this.resultMap[c])))
          }
          else if(n(o))for(p=0;
                           p<o.length;
                           p++)this._analyze(e, o[p], r, c)
        }
      }
          , r.prototype._computeScore=function() {
        var e, o, r, c, n, d, i, m, t, _=this._keyMap, s=this.results;
        for(this.options.verbose&&a("\n\nComputing score:\n"), e=0;
            e<s.length;
            e++) {
          for(r=0, c=s[e].output, n=c.length, m=1, o=0;
              o<n;
              o++)d=c[o].score, i=_?_[c[o].key].weight: 1, t=d*i, 1!==i?m=Math.min(m, t): (r+=t, c[o].nScore=t);
          s[e].score=1===m?r/n: m, this.options.verbose&&a(s[e])
        }
      }
          , r.prototype._sort=function() {
        var e=this.options;
        e.shouldSort&&(e.verbose&&a("\n\nSorting...."), this.results.sort(e.sortFn))
      }
          , r.prototype._format=function() {
        var e, o, r, c, n=this.options, d=n.getFn, i=[], m=this.results, t=n.include;
        for(n.verbose&&a("\n\nOutput:\n\n", m), r=n.id?function(e) {
              m[e].item=d(m[e].item, n.id, [])[0]
            }
            :function() {}
                , c=function(e) {
          var o, a, r, c, n, d=m[e];
          if(t.length>0) {
            if(o= {
                  item: d.item
                    ...
                    , -1!==t.indexOf("matches"))for(r=d.output, o.matches=[], a=0;
                                                    a<r.length;
                                                    a++)c=r[a], n= {
                indices: c.matchedIndices
              }
                  , c.key&&(n.key=c.key), o.matches.push(n);
            -1!==t.indexOf("score")&&(o.score=m[e].score)
          }
          else o=d.item;
          return o
        }
        ...
        return i
          ...
          , d.defaultOptions= {
        location: 0, distance: 100, threshold: .6, maxPatternLength: 32
      }
          , d.prototype._calculatePatternAlphabet=function() {
        var e= {}
            , o=0;
        for(o=0;
            o<this.patternLen;
            o++)e[this.pattern.charAt(o)]=0;
        for(o=0;
            o<this.patternLen;
            o++)e[this.pattern.charAt(o)]|=1<<this.pattern.length-o-1;
        return e
      }
          , d.prototype._bitapScore=function(e, o) {
        var a=e/this.patternLen, r=Math.abs(this.options.location-o);
        return this.options.distance?a+r/this.options.distance: r?1: a
      }
          , d.prototype.search=function(e) {
        var o, a, r, c, n, d, i, m, t, _, s, l, f, g, h, u, y, j, p, b, k, w, v, x=this.options;
        ...
        if(this.patternLen>x.maxPatternLength) {
          if(j=e.match(new RegExp(this.pattern.replace(x.tokenSeparator, "|"))), p=!!j)for(k=[], o=0, w=j.length;
                                                                                           o<w;
                                                                                           o++)v=j[o], k.push([e.indexOf(v), v.length-1]);
          return {
            isMatch: p, score: p?.5: 1, matchedIndices: k
          }
        }
        for(c=x.findAllMatches, n=x.location, r=e.length, d=x.threshold, i=e.indexOf(this.pattern, n), b=[], o=0;
            o<r;
            o++)b[o]=0;
        for(-1!=i&&(d=Math.min(this._bitapScore(0, i), d), -1!=(i=e.lastIndexOf(this.pattern, n+this.patternLen))&&(d=Math.min(this._bitapScore(0, i), d))), i=-1, u=1, y=[], _=this.patternLen+r, o=0;
            o<this.patternLen;
            o++) {
          for(m=0, t=_;
              m<t;
          )this._bitapScore(o, n+t)<=d?m=t: _=t, t=Math.floor((_-m)/2+m);
          for(_=t, s=Math.max(1, n-t+1), l=c?r: Math.min(n+t, r)+this.patternLen, f=Array(l+2), f[l+1]=(1<<o)-1, a=l;
              a>=s;
              a--)if(h=this.patternAlphabet[e.charAt(a-1)], h&&(b[a-1]=1), f[a]=(f[a+1]<<1|1)&h, 0!==o&&(f[a]|=(g[a+1]|g[a])<<1|1|g[a+1]), f[a]&this.matchmask&&(u=this._bitapScore(o, a-1))<=d) {
            if(d=u, i=a-1, y.push(i), i<=n)break;
            s=Math.max(1, 2*n-i)
          }
          if(this._bitapScore(o+1, n)>d)break;
          g=f
        }
        return k=this._getMatchedIndices(b), {
          isMatch: i>=0, score: 0===u?.001: u, matchedIndices: k
        }
      }
          , d.prototype._getMatchedIndices=function(e) {
        for(var o, a=[], r=-1, c=-1, n=0, d=e.length;
            n<d;
            n++)o=e[n], o&&-1===r?r=n: o||-1===r||(c=n-1, c-r+1>=this.options.minMatchCharLength&&a.push([r, c]), r=-1);
        return e[n-1]&&n-1-r+1>=this.options.minMatchCharLength&&a.push([r, n-1]), a
      }
          , e.exports=r
    }
    ()
  ...
  , function(e, o, a) {
    ...
    (n), i=a(0), m=Quill.import("delta"), t=function(e, o) {
      for(var a=arguments.length, r=Array(a>2?a-2: 0), c=2;
          c<a;
          c++)r[c-2]=arguments[c];
      ...
      return Object.keys(o).forEach(function(e) {
        ...
        , _=function() {
      function e(o, a) {
        r(this, e), this.fuseOptions= {
          shouldSort: !0, threshold: .1, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: 3, keys: ["shortname"]
        }
            , this.emojiList=i.emojiList, this.fuse=new d.default(this.emojiList, this.fuseOptions), this.quill=o, this.onClose=a.onClose, this.onOpen=a.onOpen, this.container=document.createElement("ul"), this.container.classList.add("emoji_completions"), this.quill.container.appendChild(this.container), this.container.style.position="absolute", this.container.style.display="none", this.onSelectionChange=this.maybeUnfocus.bind(this), this.onTextChange=this.update.bind(this), this.open=!1, this.atIndex=null, this.focusedButton=null, this.isWhiteSpace=function(e) {
          var o=!1;
          return/\s/.test(e)&&(o=!0), o
        }
            , o.keyboard.addBinding( {
              key: 186, shiftKey: !0
            }
            , this.onAtKey.bind(this)), o.keyboard.addBinding( {
              key: 39, collapsed: !0, format: ["emoji"]
            }
            , this.handleArrow.bind(this)), o.keyboard.addBinding( {
              key: 40, collapsed: !0, format: ["emoji"]
            }
            , this.handleArrow.bind(this))
      }
      return c(e, [ {
        key:"onAtKey", value:function(e, o) {
          if(this.open)return!0;
          e.length>0&&this.quill.deleteText(e.index, e.length, Quill.sources.USER), this.quill.insertText(e.index, ":", "emoji", Quill.sources.USER);
        ...
        , {
          key:"update", value:function() {
            ...
            if(this.query=this.quill.getText(this.atIndex+1, e-this.atIndex-1), !event&&this.isWhiteSpace(this.query))return void this.close(null);
            this.query=this.query.trim();
            var o=this.fuse.search(this.query);
            if(o.sort(function(e, o) {
                      return e.emoji_order-o.emoji_order
                    }
                ), this.query.length<3||0==o.length)return void(this.container.style.display="none");
            o.length>50&&(o=o.slice(0, 40)), this.renderCompletions(o)
          }
        }
        , {
        ...
        , {
          key:"renderCompletions", value:function(e) {
            ...
            if(!event) {
              ...
              var r=function(e, r) {
                    return function(c) {
                      if("ArrowRight"===c.key||39===c.keyCode)c.preventDefault(), a[Math.min(a.length-1, e+1)].focus();
                      else if("Tab"===c.key||9===c.keyCode) {
                        if(c.preventDefault(), e+1==a.length)return void a[0].focus();
                        a[Math.min(a.length-1, e+1)].focus()
                      }
                      else"ArrowLeft"===c.key||37===c.keyCode?(c.preventDefault(), a[Math.max(0, e-1)].focus()):"ArrowDown"===c.key||40===c.keyCode?(c.preventDefault(), a[Math.min(a.length-1, e+1)].focus()):"ArrowUp"===c.key||38===c.keyCode?(c.preventDefault(), a[Math.max(0, e-1)].focus()):"Enter"!==c.key&&13!==c.keyCode&&" "!==c.key&&32!==c.keyCode&&"Tab"!==c.key&&9!==c.keyCode||(c.preventDefault(), o.quill.enable(), o.close(r))
                    }
                  }
              ;
              if(e.forEach(function(e, c) {
                        var n=t("li", {}
                            , t("button", {
                                  type: "button"
                                }
                                , t("span", {
                                    ...
                                    , e.shortname)));
                        o.container.appendChild(n), a[c]=n.firstChild, a[c].addEventListener("keydown", r(c, e)), a[c].addEventListener("mousedown", function() {
                              return o.close(e)
                            }
                        ), a[c].addEventListener("focus", function() {
                              return o.focusedButton=c
                            }
                        ), a[c].addEventListener("unfocus", function() {
                              return o.focusedButton=null
                            }
                        )
                      }
                  ), this.container.style.display="block", this.quill.container.classList.contains("top-emoji")) {
                var c=this.container.querySelectorAll("li"), n=void 0;
                for(n=0;
                    n<c.length;
                    n++)c[n].style.display="block";
                var d=window.innerHeight;
                this.quill.container.getBoundingClientRect().top>d/2&&this.container.offsetHeight>0&&(this.container.style.top="-"+this.container.offsetHeight+"px")
              }
              a[0].classList.add("emoji-active")
            }
          }
        }
        , {
          key:"close", value:function(e) {
            ...
            if(this.quill.off("selection-change", this.onSelectionChange), this.quill.off("text-change", this.onTextChange), e) {
              e.name, e.unicode, e.shortname, e.code_decimal;
              this.quill.deleteText(this.atIndex, this.query.length+1, Quill.sources.USER), this.quill.insertEmbed(this.atIndex, "bolt", e)
            }
            this.quill.focus(), this.open=!1, this.onClose&&this.onClose(e)
          }
        }
        , {
          key:"enterEmoji", value:function(e) {
            if(e) {
              var o=(e.name, e.unicode, e.shortname, e.code_decimal), a=t("span", {
                    className: "ico", innerHTML: " "+o+" "
                  }
              ), r=(a.innerHTML, new m, this.quill.getSelection()), c=[];
              if(this.atIndex>0) {
                var n=r.index-this.query.length;
                n>2&&(n-=2), c.push( {
                      retain: n
                    }
                )
    ...
    ();
    Quill.register("modules/short_name_emoji", _), o.shortNameEmoji=_
  }
  ...
  , function(e, o, a) {
    ...
    function t(e, o, a) {
      ...
      var m=i(a);
      n.map(function(e) {
            var r=document.createElement("span"), c=document.createTextNode(e.shortname);
            r.appendChild(c), r.classList.add("bem"), r.classList.add("bem-"+e.name), r.classList.add("ap"), r.classList.add("ap-"+e.name);
            var n=""+e.code_decimal;
            r.innerHTML=n+" ", o.appendChild(r);
            var i=document.querySelector(".bem-"+e.name);
            i&&i.addEventListener("click", function() {
                  var char = " "+String.fromCodePoint("0x"+e.unicode)+" ";
                  a.insertText(m.index, char), d()
                  a.setSelection(m.index+char.length);
                }
            )
          }
      )
    ...
    (f), h=a(0), u=(Quill.import("delta"), Quill.import("blots/embed")), y=function(e) {
      function o() {
        return r(this, o), c(this, (o.__proto__||Object.getPrototypeOf(o)).apply(this, arguments))
      }
      return n(o, e), s(o, [ {
        key:"format", value:function(e, a) {
          "class"===e||"alt"===e?a?this.domNode.setAttribute(e, a): this.domNode.removeAttribute(e, a): l(o.prototype.__proto__||Object.getPrototypeOf(o.prototype), "format", this).call(this, e, a)
        }
      }
      ], [ {
        key:"create", value:function(e) {
          var a=l(o.__proto__||Object.getPrototypeOf(o), "create", this).call(this);
          if("object"===(void 0===e?"undefined": _(e))) {
            a.classList.add("emoji"), a.classList.add("ap"), a.classList.add("ap-"+e.name);
            a.setAttribute("data-unicode", e.unicode);
            a.setAttribute("data-char", String.fromCodePoint("0x"+e.unicode));
            a.setAttribute("data-decimal", e.code_decimal);
            a.setAttribute("src", "data:image/png;base64,R0lGODlhAQABAAAAACwAAAAAAQABAAA=")
          }
          else"string"==typeof e&&a.setAttribute("src", e);
          return a
        }
      }
        , {
      ...
      return s(e, [ {
        key:"checkEmojiBoxExist", value:function() {
          ...
          if(e)e.remove();
            ...
            a.id="tab-toolbar", o.appendChild(a);
            var r=[ {
            ...
            if(a.appendChild(c), null===document.getElementById("emoji-close-div")) {
              var n=document.createElement("div");
              n.id="emoji-close-div", n.addEventListener("click", d, !1), document.getElementsByTagName("body")[0].appendChild(n)
            }
            ...
            r.map(function(e) {
                  ...
                  var a=e.content;
                  o.innerHTML=a, o.dataset.filter=e.type, c.appendChild(o);
                  ...
                  r.addEventListener("click", function() {
                        ...
                        t(r.dataset.filter, i, _)
                      }
                  )
                }
            );
            var s=window.innerHeight;
            this.quill.container.getBoundingClientRect().top>s/2&&(o.style.top="-250px"), m(i, this.quill)
          }
        }
      }
      ]), e
    ...
    ();
    Quill.register("modules/textarea_emoji", j), o.textAreaEmoji=j
  }
  ...
  , function(e, o, a) {
    ...
    function t(e) {
      var o=document.createElement("div"), a=(document.querySelector(".ql-toolbar"), e.getSelection()), r=e.getBounds(a.index);
      e.container.appendChild(o);
      var c=r.left+250;
      o.id="emoji-palette", o.style.top=10+r.top+r.height+"px", c>e.container.offsetWidth?o.style.left=r.left-250+"px": o.style.left=r.left+"px";
      var n=document.createElement("div");
      ...
      if(n.appendChild(t), null===document.getElementById("emoji-close-div")) {
        var s=document.createElement("div");
        s.id="emoji-close-div", s.addEventListener("click", d, !1), document.getElementsByTagName("body")[0].appendChild(s)
      }
      else document.getElementById("emoji-close-div").style.display="block";
      m.map(function(o) {
            var a=document.createElement("li");
            a.classList.add("emoji-tab"), a.classList.add("filter-"+o.name);
            var r=o.content;
            a.innerHTML=r, a.dataset.filter=o.type, t.appendChild(a);
            var c=document.querySelector(".filter-"+o.name);
            c.addEventListener("click", function() {
                  var o=document.querySelector(".active");
                  o&&o.classList.remove("active"), c.classList.toggle("active"), l(c, i, e)
                }
            )
          }
      ), _(i, e)
    ...
    function _(e, o) {
      s("p", e, o), document.querySelector(".filter-people").classList.add("active")
    }
    function s(e, o, a) {
      var r= {
        shouldSort: !0, matchAllTokens: !0, threshold: .3, location: 0, distance: 100, maxPatternLength: 32, minMatchCharLength: 3, keys: ["category"]
      }
          , c=new y.default(j.emojiList, r), n=c.search(e);
      n.sort(function(e, o) {
            return e.emoji_order-o.emoji_order
          }
      ), a.focus();
      ...
      n.map(function(e) {
            ...
            var n=""+e.code_decimal;
            r.innerHTML=n+" ", o.appendChild(r);
            var m=document.querySelector(".bem-"+e.name);
            m&&m.addEventListener("click", function() {
                  ...
                  o.innerHTML;
                  a.insertEmbed(i.index, "bolt", e), d()
                }
            )
          }
      )
    ...
    function l(e, o, a) {
      ...
      s(e.dataset.filter, o, a)
    }
    Object.defineProperty(o, "__esModule", {
          value: !0
        }
    ), o.toolbarEmoji=void 0;
    ...
    (u), j=a(0), p=(Quill.import("delta"), function(e, o) {
          for(var a=arguments.length, r=Array(a>2?a-2: 0), c=2;
              c<a;
              c++)r[c-2]=arguments[c];
          var n=document.createElement(e);
    ...
    ), b=Quill.import("blots/embed"), k=function(e) {
      function o() {
        return r(this, o), c(this, (o.__proto__||Object.getPrototypeOf(o)).apply(this, arguments))
      }
      return n(o, e), g(o, [ {
        key:"format", value:function(e, a) {
          "class"===e||"alt"===e?a?this.domNode.setAttribute(e, a): this.domNode.removeAttribute(e, a): h(o.prototype.__proto__||Object.getPrototypeOf(o.prototype), "format", this).call(this, e, a)
        }
      }
      ], [ {
        key:"create", value:function(e) {
          var a=h(o.__proto__||Object.getPrototypeOf(o), "create", this).call(this);
    ...
    (b);
    k.blotName="bolt", k.tagName="img", Quill.register( {
          "formats/bolt": k
        }
    );
    var w=function() {
      function e(o) {
        r(this, e), this.quill=o, this.toolbar=o.getModule("toolbar"), void 0!==this.toolbar&&this.toolbar.addHandler("emoji", this.checkPalatteExist);
        var a=document.getElementsByClassName("ql-emoji");
        a&&[].slice.call(a).forEach(function(e) {
              e.innerHTML='<svg viewbox="0 0 18 18"><circle class="ql-fill" cx="7" cy="7" r="1"></circle><circle class="ql-fill" cx="11" cy="7" r="1"></circle><path class="ql-stroke" d="M7,10a2,2,0,0,0,4,0H7Z"></path><circle class="ql-stroke" cx="9" cy="9" r="6"></circle></svg>'
            }
        )
      }
      return g(e, [ {
        key:"checkPalatteExist", value:function() {
          var e=this.quill;
          i(e), this.quill.on("text-change", function(o, a, r) {
                "user"==r&&(d(), m(e))
              }
          )
        }
    ...
    ();
    Quill.register("modules/toolbar_emoji", w), o.toolbarEmoji=w
  }
  ...
  , function(e, o, a) {
    ...
    var c=a(5), n=(r(c), a(2)), d=(r(n), a(4)), i=(r(d), a(3));
    r(i)
  }
